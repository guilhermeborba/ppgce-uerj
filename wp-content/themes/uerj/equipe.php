...
<section id="content"class="home-apresentacao">
    <div class="content-wrap">
        <div class="container clearfix">
            <h3>COORDENAÇÃO E SECRETARIA PPGCE UERJ</h3>
    ...
    <div class="content-wrap" style="padding-top:0;">
        <div class="container clearfix">
            <div id="posts" class="post-grid grid-container clearfix">
                <h2 style="position:relative!important;"><strong>Comissão de Pós Graduação em Ciências Econômica</strong> UERJ</h2>
                <?php
                    global $post;
                    $args_pessoas = array(      
                            'order' => 'asc',
            ...
            <div id="posts" class="post-grid grid-container clearfix">
                <h2 style="position:relative!important;"><strong>Coordenadores da Pós</strong> UERJ</h2>
                <?php
                    global $post;
                    $args_pessoas = array(      
                            'order' => 'asc',
            ...
            <div id="posts" class="post-grid grid-container clearfix">
                <h2 style="position:relative!important;"><strong>Quadro de funcionários administrativo</strong> UERJ</h2>
                <?php
                    global $post;
                    $args_pessoas = array(      
                            'order' => 'asc',
